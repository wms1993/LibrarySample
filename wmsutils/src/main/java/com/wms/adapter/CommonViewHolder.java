...
public class CommonViewHolder extends RecyclerView.ViewHolder {
    ...
    public CommonViewHolder setText(int id, String text, String defaultValue) {
    ...
    public CommonViewHolder setText(int id, String text, int color) {
        TextView textView = getView(id);
        textView.setText(text);
    ...
    public CommonViewHolder setText(int id, String text, int color, float fontSize) {
        TextView textView = getView(id);
        textView.setText(text);
        textView.setTextColor(color);
    ...
    public CommonViewHolder setText(int id, String text, float fontSize) {
        TextView textView = getView(id);
        textView.setText(text);
        textView.setTextSize(fontSize);
        return this;
    ...
    public CommonViewHolder setImageColor(int id, int color) {
        ImageView imageView = getView(id);
